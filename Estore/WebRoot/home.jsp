...
function ProductFindByPageCodeServlet(id){
	location.href="http://localhost:8080/Estore/ProductFindByPageCodeServlet?code="+id;
};
function phone(obj) {
...
<div id="carousel-example-generic" class="carousel slide" data-ride="carousel">
    ...
    <div class="carousel-inner" role="listbox">
        ...
        <div class="item">
            <img src="home/img/iphone_square_large.jpg" alt="..." onclick="phone('Phone')">
            <div class="carousel-caption">

            </div>
        </div>
        <div class="item">
            <img src="home/img/holiday_hero_subhead_2a_largetall.jpg" alt="..." onclick="phone('Pad')">
            <div class="carousel-caption">
            </div>
        </div>

        <div class="item">
        <img src="home/img/macbookpro_large.jpg" alt="..." onclick="phone('Laptop')">
        <div class="carousel-caption">
        </div>
        </div>

        <div class="item">
            <img src="home/img/tile_macos_large.jpg" alt="..." onclick="phone('Components')">
            <div class="carousel-caption">
            </div>
        </div>
...
<section class="sec1">
    <a><img src="home/img/1.png" onclick="ProductFindByPageCodeServlet('51')"></a>
    <a><img src="home/img/2.png" onclick="ProductFindByPageCodeServlet('52')"></a>
    <a><img src="home/img/4.png" onclick="ProductFindByPageCodeServlet('53')"></a>
    <a><img src="home/img/5.jpg" onclick="ProductFindByPageCodeServlet('54')"></a>
</section>
<section class="sec2">
    <h3>Phone</h3>
